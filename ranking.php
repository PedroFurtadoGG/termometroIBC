    ...
    <div class="container">
        <div class="col-md-8 mr-auto ml-auto row">
            <div class="share col-12">
                <img src="<?php echo $url;?>/library/images/share/termometro-resultado-quente.png" alt="" class="img-thumbnail">
            </div>
            <div class="midias text-center col-12 py-3">
                <h4><b>COMPARTILHE COM SEUS AMIGOS</b></h4>
                <div class="links d-block text-center">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=" class="d-inline-block"><img src="<?php echo $url;?>/library/images/bt-facebook-g.png" alt=""></a>
                    <a href="#" class="d-inline-block"><img src="<?php echo $url;?>/library/images/bt-gplus-g.png" alt=""></a>
                    <a href="#" class="d-inline-block"><img src="<?php echo $url;?>/library/images/bt-twitter-g.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
