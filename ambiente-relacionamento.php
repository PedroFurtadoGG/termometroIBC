...
<section class="breadcrub">
    <div class="container">
        <div class="col-md-9 mr-auto ml-auto row text-center pt-2 pb-1">
            <h3 class="text-center col-12"><b>Questionário:</b> Ambiente Relacionamento</h3>
        </div>
    </div>
</section>
            ...
            <div class="ambientes col-12">
                ...
                <div class="ambiente-qdv row">
                    <div class="col-sm-9 pr-0 pt-4">
                        <img src="<?php echo $url;?>/library/images/ambiente-relacionamento.png" alt="">
                    </div>
                    <div class="col-sm-3 pl-0 pt-4">
                        <img src="<?php echo $url;?>/library/images/tag-relacionamento.png" alt="">
                    </div>
